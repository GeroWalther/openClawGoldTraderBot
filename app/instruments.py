...
INSTRUMENTS: dict[str, InstrumentSpec] = {
    ...
    "NZDUSD": InstrumentSpec(
        ...
        min_size=1000,
        max_size=500000,
        default_sl_distance=0.0040,
        default_tp_distance=0.0080,
        min_stop_distance=0.0005,
        max_stop_distance=0.0500,
    ...
    "AUDUSD": InstrumentSpec(
        ...
        min_size=1000,
        max_size=500000,
        default_sl_distance=0.0045,
        default_tp_distance=0.0090,
        min_stop_distance=0.0005,
        max_stop_distance=0.0500,
    ...
    "GBPUSD": InstrumentSpec(
        ...
        min_size=1000,
        max_size=500000,
        default_sl_distance=0.0060,
        default_tp_distance=0.0120,
        min_stop_distance=0.0005,
        max_stop_distance=0.0500,
